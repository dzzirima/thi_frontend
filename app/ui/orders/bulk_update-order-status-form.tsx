...
import { bulkUpdateOrder , State} from "@/app/actions/order/bulk_update_order_action";

export default function BulkUpdateOrderStatusForm(order: { order: any }) {
  const initialState: State = { message: "", errors: {} };
  const [state, dispatch] = useFormState(bulkUpdateOrder, initialState);
  return (
